      ...
      <Container className="px-5 py-14 relative">
        <div>
          ...
          <p className="max-w-3xl text-lg leading-8 mb-10 font-mono text-center md:text-start">
            I&apos;m an aspiring junior fullstack developer currently enrolled
            on the Code Nation: Master Software bootcamp. My speciality is in
            designing modern minimalist web apps, I&apos;m currently focusing on
            learning modern web technologies such as Next.js, Typescript,
